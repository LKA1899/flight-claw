            ...
            detail_json = json.dumps(
                {
                    ...
                    "outbound_airline": outbound.airline if outbound else None,
                    "outbound_flight_no": outbound.flight_no if outbound else None,
                    "outbound_depart_time": outbound.depart_time if outbound else None,
                    "outbound_arrive_time": outbound.arrive_time if outbound else None,
                    "outbound_depart_airport": outbound.depart_airport if outbound else None,
                    "outbound_arrive_airport": outbound.arrive_airport if outbound else None,
                    "return_airline": return_row.airline if return_row else None,
                    "return_flight_no": return_row.flight_no if return_row else None,
                    "return_depart_time": return_row.depart_time if return_row else None,
                    "return_arrive_time": return_row.arrive_time if return_row else None,
                    "return_depart_airport": return_row.depart_airport if return_row else None,
                    "return_arrive_airport": return_row.arrive_airport if return_row else None,
